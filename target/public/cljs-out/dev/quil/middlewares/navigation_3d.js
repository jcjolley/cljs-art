...
var vec__8383 = axis;
var a_x = cljs.core.nth.call(null,vec__8383,(0),null);
var a_y = cljs.core.nth.call(null,vec__8383,(1),null);
var a_z = cljs.core.nth.call(null,vec__8383,(2),null);
var vec__8386 = v;
var x = cljs.core.nth.call(null,vec__8386,(0),null);
var y = cljs.core.nth.call(null,vec__8386,(1),null);
var z = cljs.core.nth.call(null,vec__8386,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__8389,p__8390){
var vec__8391 = p__8389;
var u1 = cljs.core.nth.call(null,vec__8391,(0),null);
var u2 = cljs.core.nth.call(null,vec__8391,(1),null);
var u3 = cljs.core.nth.call(null,vec__8391,(2),null);
var vec__8394 = p__8390;
var v1 = cljs.core.nth.call(null,vec__8394,(0),null);
var v2 = cljs.core.nth.call(null,vec__8394,(1),null);
var v3 = cljs.core.nth.call(null,vec__8394,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__8397_SHARP_){
return (p1__8397_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__8398_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__8399_SHARP_,angle_lr),angle_ud);
...
var map__8401 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__8401__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__8401__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5718__auto__ = (function (){var pred__8403 = cljs.core._EQ_;
var expr__8404 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__8403.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__8404))){
return straight;
} else {
if(cljs.core.truth_(pred__8403.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__8404))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__8403.call(null,quil.middlewares.navigation_3d.space,expr__8404))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__8403.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__8404))){
return up;
} else {
if(cljs.core.truth_(pred__8403.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__8404))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__8403.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__8404))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5718__auto__,map__8401,map__8401__$1,up,straight){
return (function (p1__8400_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__8400_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5718__auto__,map__8401,map__8401__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__8406_SHARP_);
});})(initial_state))
);
});
/**
...
var map__8407_8418 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__8407_8419__$1 = ((((!((map__8407_8418 == null)))?(((((map__8407_8418.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__8407_8418.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8407_8418):map__8407_8418);
var vec__8408_8420 = cljs.core.get.call(null,map__8407_8419__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_8421 = cljs.core.nth.call(null,vec__8408_8420,(0),null);
var c_y_8422 = cljs.core.nth.call(null,vec__8408_8420,(1),null);
var c_z_8423 = cljs.core.nth.call(null,vec__8408_8420,(2),null);
var vec__8411_8424 = cljs.core.get.call(null,map__8407_8419__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_8425 = cljs.core.nth.call(null,vec__8411_8424,(0),null);
var u_y_8426 = cljs.core.nth.call(null,vec__8411_8424,(1),null);
var u_z_8427 = cljs.core.nth.call(null,vec__8411_8424,(2),null);
var vec__8414_8428 = cljs.core.get.call(null,map__8407_8419__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_8429 = cljs.core.nth.call(null,vec__8414_8428,(0),null);
var p_y_8430 = cljs.core.nth.call(null,vec__8414_8428,(1),null);
var p_z_8431 = cljs.core.nth.call(null,vec__8414_8428,(2),null);
quil.core.camera.call(null,p_x_8429,p_y_8430,p_z_8431,(p_x_8429 + c_x_8421),(p_y_8430 + c_y_8422),(p_z_8431 + c_z_8423),u_x_8425,u_y_8426,u_z_8427);
