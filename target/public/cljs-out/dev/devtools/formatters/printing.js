...
var G__11218 = (i__4532__auto___11217 + (1));
i__4532__auto___11217 = G__11218;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq11213){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11214,G__11215,seq11213__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__11219_SHARP_){
return !((cljs.core.meta.call(null,p1__11219_SHARP_) == null));
})))){
...
var map__11220 = opts;
var map__11220__$1 = ((((!((map__11220 == null)))?(((((map__11220.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__11220.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11220):map__11220);
var markup_db = cljs.core.get.call(null,map__11220__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e11224){var _e__10204__auto__ = e11224;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e11226){var _e__10204__auto__ = e11226;
return false;
}}
})())){
...
var _STAR_current_state_STAR_11228 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__11229 = opts;
...
var markup_db = cljs.core.get.call(null,map__11229__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_11228;
}});
...
;
var temp__5718__auto___11233 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___11233)){
var managed_print_level_11234 = temp__5718__auto___11233;
var _STAR_print_level_STAR_11232_11235 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_11234;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_11232_11235,managed_print_level_11234,temp__5718__auto___11233,writer,opts,job_fn){
return (function (p1__11231_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__11231_SHARP_,null);
});})(_STAR_print_level_STAR_11232_11235,managed_print_level_11234,temp__5718__auto___11233,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_11232_11235;
}} else {
job_fn.call(null);
}
